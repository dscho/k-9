...
class EditEmailAddressList : K9ListActivity(), OnItemClickListener, EditEmailAddressListDialogListener {
    ...
    override fun onModifyEmail(oldEmail: String?, newEmail: String?) {
        ...
        arrayAdapter.sort(Comparator { o1, o2 ->
            when {
                o1 == "+ Add to list" -> +1
                o2 == "+ Add to list" -> -1
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            return activity?.let {
                ...
                builder.setView(view)
                    .setPositiveButton(R.string.account_settings_edit_email_address_modify,
                        DialogInterface.OnClickListener { dialog, id ->
                            listener.onModifyEmail(originalEmail, editEmailAddress.text.toString())
                        })
                    .setNegativeButton(R.string.account_settings_edit_email_address_remove,
                        DialogInterface.OnClickListener { dialog, id ->
